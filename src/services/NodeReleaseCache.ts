 ...
 * release filtering.
 *
 * Unlike the Bun and Deno equivalents this service is not a plain type alias
 ...
 * @public
 */
export class NodeReleaseCache extends Context.Tag("runtime-resolver/NodeReleaseCache")<
	NodeReleaseCache,
	RuntimeCache<NodeRelease> & {
		/**
